...
Ejemplo sencillo de condicional podría ser
```
age = 17
if(age >= 18) :
...
def ExamStatus (name, date, status) :
	printf(‘Alumno {name}, {status} la materia, el dia {date}’)
